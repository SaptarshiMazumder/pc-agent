...
export interface AppState {
  ...
  /** Bumped whenever this chat's workspace folders may have changed — a reference added, a tool
   *  result that declared a file, a turn that ended — so the file panel re-reads them at once. A
