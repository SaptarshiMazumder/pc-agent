...
export interface ConfigData {
  ...
  /** May the person running it change those? FALSE by default — the author's choices are the
...
export function useSettings(client: AgentdClient, agentId: string) {
   ...
   *  daemon will drop a write to it — see `config.set`. */
  ...
  /** Which of the three layers produced the value — the badge beside the row. */
