 ...
 *
 * ONE COPY. The agent table and the ship screen both need this; two inline copies of an org fetch
 * is how one of them ends up asking at a different moment and disagreeing about whether the user
 * is in an org — which, here, would silently publish an enterprise's agent to the public.
 */
