...
window.Chat = (function () {
   ...
   *
   *  `explanation` is in the list for `update_plan`, whose whole point is the note about what
   *  just changed — it is the most useful thing that tool can show while a build runs.
   */
  function describe(v) {
    if (v == null) return ''
