...
`infrastructure` (both may import DOWN into it): the offline CLI (`agentd.main.list_plugins`)
passes freshly COLD-discovered tools via `build_catalog`; the running gateway
(`agentd.presentation.gateway`) passes the LIVE registered tools. Keeping it below both is what
