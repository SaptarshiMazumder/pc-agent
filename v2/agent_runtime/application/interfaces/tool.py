...
(Historically these types lived in ``agent_runtime.infrastructure.tools``; that module now RE-EXPORTS
them from here for backward compatibility, so existing ``from agent_runtime.infrastructure.tools import
...
from agent_runtime.domain.messages import ContentBlock, TextContent
