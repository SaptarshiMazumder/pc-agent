...
from agent_runtime.infrastructure.safe_to_send.gate import JudgeFn, LlmSafeToSendGate
...
def _build_judge_fn(config) -> JudgeFn | None:
    ...
    from agent_runtime.application.tool_models import safe_to_send_model
