...
class PlaywrightBrowserProvider(BaseBrowserSession):
    ...
    async def _create_context(self):
        ...
        if self.mode == "persistent":
            ...
            # via `python -m agent_runtime.main.browser_login`, OR seed from an existing
    ...
    async def profiles(self) -> dict:
        ...
        return {
            ...
            "hint": "Log in once headed via `python -m agent_runtime.main.browser_login`. To drive your "
