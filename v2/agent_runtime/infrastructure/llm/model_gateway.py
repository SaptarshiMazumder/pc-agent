...
New code imports :mod:`agent_runtime.infrastructure.llm.model_proxy`. This module remains so
older plugins and integrations do not break during the naming migration.
"""

from agent_runtime.infrastructure.llm.model_proxy import apply, configure, enabled, status
